    ...
    public class Imdb
    {
        ...
        private ImdbInfo fetchImdbInfo(string imdbId)
        {
            try
            {
                ...
                var posterImageNode = doc.DocumentNode.SelectSingleNode("//*[@id='title-overview-widget']/div[1]/div[3]/div[1]/a/img") ?? doc.DocumentNode.SelectSingleNode("//*[@id='title-overview-widget']/div[2]/div[1]/a/img") ?? doc.DocumentNode.SelectSingleNode("//*[@id='title-overview-widget']/div[1]/div[4]/div[1]/a/img");
